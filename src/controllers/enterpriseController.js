// Business Logic Controller for Aplikasi Sekolah Enterprise
let enterpriseData = [
    { id: 1001, title: 'Modul Utama Aplikasi Sekolah Enterprise', category: 'Core Operational', amount: 35000000, status: 'Aktif', date: '2026-07-24' },
...
exports.getAnalytics = async (req, res) => {
    res.json({
        success: true,
        platform: 'Aplikasi Sekolah Enterprise',
